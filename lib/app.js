...
app.post('/clothes', async (req, res) => {
  try {
    ...
    insert into clothes (clothing_id, name, img_url, description, category, size, price, owner_id)
...
app.put('/clothes/:id', async (req, res) => {
  ...
  try {
    const data = await client.query(`
    UPDATE clothes
    SET clothing_id = $1, name = $2, img_url = $3, description = $4, category= $5, size = $6, price = $7 
    WHERE id = $8
    returning *;
    `,
      [
